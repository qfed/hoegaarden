...
function encoderFormatter(key: string) {

  return (result: any, value: any) => {
    if (value === undefined) {
      return result;
    }
    if (value === null) {
...
function parserFormatter(key: string, value: string, accumulator: any): string | Array<string | number | boolean> {
...
function keysSorter(argc: any): any {
...
function stringify(obj: { [propName: string]: string | number | boolean }): string {
